export default {
    ...
    home: {
        ...
        landing: {
            ...
            buildingTitle: 'Ihr Restaurant wird eingerichtet',
            buildingText: 'Wir bereiten Ihre Umgebung vor. Sie werden gleich zu Ihrer neuen Seite weitergeleitet.',
            postRegisterTitle: 'Fast geschafft',
            postRegisterText: 'Ihr Konto wartet auf Freigabe. Ein Administrator muss es bestätigen, bevor Sie sich anmelden und Ihr Restaurant-Dashboard nutzen können.',
            postRegisterCta: 'Zur Restaurant-Anmeldung',
            ...
            tipProducts: 'Alles markieren, was Sie interessiert. Später anpassbar.',
    ...
    auth: {
        login: {
            ...
            adminPending: 'Ihr Konto wartet auf Genehmigung. Bitte warten Sie, bis ein Administrator es freigibt.',
            registeredInfo: 'Registrierung eingegangen. Ihr Konto wird freigeschaltet, sobald ein Administrator es bestätigt.'
        },
        superAdmin: {
            title: 'Super-Admin-Anmeldung',
            subtitle: 'Melden Sie sich mit Ihren Plattform-Zugangsdaten im Dashboard an.',
            tipEmail: 'Die E-Mail-Adresse Ihres AiRestro-360-Superadministrator-Kontos.',
